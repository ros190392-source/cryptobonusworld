...
Research languages: English, Russian, and the primary local language of Kazakhstan where official sources exist.
...
a regulator warning alone. Do not use EEA/MiCA or other foreign licensing as Kazakhstan evidence.
