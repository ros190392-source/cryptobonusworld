    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'After clicking <strong>Payment Completed</strong>, the order status switches to <strong>Pending for Release</strong>. The seller has been notified and will now verify that the transfer arrived in their bank account. Most sellers respond within 2–10 minutes. Stay on this page — the status updates automatically the moment the seller releases your crypto.',
          src: '/media/walkthroughs/bybit/p2p-10.jpg',
          capturedAt: '2026-05',
          device: 'mobile',
          aspectRatio: '9/16',
          alt: 'Bybit P2P order page showing Pending for Release status after payment confirmation, waiting for seller to verify and release USDT',
          mediaCategory: 'P2P',
