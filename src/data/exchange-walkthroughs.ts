  ...
  flows: [
    {
      ...
      steps: [
        {
          title: 'Open the referral link — see the 19,800 USDT banner',
          description: 'Click the referral link from CryptoBonusWorld. You land on the Binance registration page with the <strong>Up to 19,800 USD Sign Up Rewards</strong> banner and the referral badge already active — exactly as in the screenshot below, captured during our own registration in June 2026. The registration form is on the right; all you need is an email address.',
          src: '/screenshots/binance/steps/bn-01-landing-empty.webp',
          capturedAt: '2026-06',
          width: 1146,
          height: 712,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance registration landing — 19,800 USDT banner, referral active',
          alt: 'Binance registration page showing the Up to 19,800 USD Sign Up Rewards banner and empty registration form (June 2026)',
          mediaCategory: 'Sign Up',
        ...
        {
          title: 'Enter your email and click Continue',
          description: 'Type your email address in the <strong>Email/Phone number</strong> field. The screenshot below is our own registration — the CryptoBonusWorld badge with code <strong>CRYPTOBONW</strong> and the "Up to 19,800 USD Sign Up Rewards" banner confirm the referral is attached. Click <strong>Continue</strong>.',
          src: '/screenshots/binance/steps/bn-02-landing-email-blurred.webp',
          capturedAt: '2026-06',
          width: 1144,
          height: 711,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance registration — email entered, CRYPTOBONW code active',
          alt: 'Binance registration form with email entered, showing the CryptoBonusWorld referral badge and Up to 19,800 USD Sign Up Rewards (June 2026)',
          mediaCategory: 'Sign Up',
        ...
        {
          title: 'Complete the security CAPTCHA',
          description: 'After clicking Continue, a CAPTCHA puzzle appears — Binance uses an image-grid challenge (pick all squares matching a category, as shown below). Select the correct images and click <strong>Verify</strong>. The puzzle resets if you make a mistake; most users solve it on the first or second try.',
          src: '/screenshots/binance/steps/bn-03-captcha-cars.webp',
          capturedAt: '2026-06',
          width: 1145,
          height: 711,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance CAPTCHA — image grid challenge',
          alt: 'Binance CAPTCHA security check — image grid asking to select matching pictures (June 2026)',
          mediaCategory: 'Sign Up',
          tip: 'The CAPTCHA is image-based, not text-based — just click the correct squares. It takes about 10 seconds.',
        },
        {
          title: 'Confirm the 6-digit email code',
          description: 'Binance sends a 6-digit verification code to your email — the screen below asks for it. Open the email, enter the code in the <strong>Verification Code</strong> field and click <strong>Continue</strong>. The code is valid for 30 minutes; use "Didn\'t receive the code?" to resend if needed.',
          src: '/screenshots/binance/steps/bn-04b-verify-code-entry-blurred.webp',
          capturedAt: '2026-06',
          width: 941,
          height: 712,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance email verification — 6-digit code entry',
          alt: 'Binance Verify your email screen asking for the 6-digit verification code sent to the registration email (June 2026)',
          mediaCategory: 'Sign Up',
          tip: 'The code email arrives within seconds. If it does not, check spam — and make sure you are entering the code on the same device where you started registration.',
        },
        {
          title: 'Create a password',
          description: 'After the code is confirmed, Binance asks you to create a password. The on-screen checklist requires 8 to 128 characters with at least 1 number and 1 upper-case letter — exactly what you see in the screenshot. Enter the password and click <strong>Continue</strong>.',
          src: '/screenshots/binance/steps/bn-06-create-password.webp',
          capturedAt: '2026-06',
          width: 940,
          height: 709,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance registration — creating a password',
          alt: 'Binance registration form with the password being entered (June 2026)',
          mediaCategory: 'Sign Up',
        ...
        {
          title: 'Check the welcome screen — your referral proof',
          description: 'Right after the password step you land on the <strong>Welcome aboard!</strong> screen. If you registered through the referral link, it explicitly states your account has been created and linked to <strong>Referral ID CRYPTOBONW</strong> — exactly as in our screenshot. This is the moment your bonus eligibility is locked in.',
          src: '/screenshots/binance/steps/bn-07-welcome-desktop.webp',
          capturedAt: '2026-06',
          width: 956,
          height: 705,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance welcome screen — referral ID confirmed',
          alt: 'Binance welcome screen confirming the account is created and linked to Referral ID CRYPTOBONW (June 2026)',
          mediaCategory: 'Sign Up',
          tip: 'This welcome screen is your proof the bonus code applied — if it does not mention a Referral ID, the code was not attached and the bonus tasks will not appear.',
        ...
        {
          title: 'Secure your account: 2FA and anti-phishing code',
          description: 'Go to <strong>Profile → Security → Two-Factor Authentication</strong> and click <strong>Enable Authenticator App</strong> on the intro screen shown below (recommended over SMS) — Binance then displays a QR code; scan it with Google Authenticator or Authy and store the backup key offline. While in Security settings, also enable the <strong>Anti-Phishing Code</strong>: a unique phrase added to every legitimate Binance email, so any email without it is phishing.',
          src: '/screenshots/binance/steps/bn-023-security-2fa-app-intro.webp',
          capturedAt: '2026-06',
          width: 1440,
          height: 713,
          device: 'desktop',
          ...
          alt: 'Binance authenticator app 2FA setup screen',
          mediaCategory: 'Security',
    ...
    },
    {
      ...
      description: 'How to complete Binance identity verification to unlock higher withdrawal limits and all trading features. Why it matters: verification is also Stage 1 task #1 of the welcome bonus — and it raises your withdrawal limit roughly 4,000-fold, as our own before/after screenshots show.',
      introHtml: '<div class="wf-intro-pair">'
        + '<figure data-lightbox-group="ce-kyc-limits" data-lightbox-src="/screenshots/binance/steps/mob-044-fees-overview-spot-limit2000.webp" data-lightbox-alt="Binance limits before KYC — 2,000 USDT daily withdrawal" data-lightbox-caption="Before KYC on our account: 24h withdrawal limit 2,000 USDT.">'
        + '<img src="/screenshots/binance/steps/mob-044-fees-overview-spot-limit2000.webp" alt="Binance fees and limits overview before KYC showing a 2,000 USDT 24h withdrawal limit (June 2026)" loading="lazy" decoding="async" width="576" height="1280" />'
        + '<figcaption>Before KYC on our account: 24h withdrawal limit — 2,000 USDT. Tap to enlarge.</figcaption></figure>'
        + '<figure data-lightbox-group="ce-kyc-limits" data-lightbox-src="/screenshots/binance/steps/mob-044d-fees-overview-verified-8m.webp" data-lightbox-alt="Binance limits after KYC — 8,000,000 USDT daily withdrawal" data-lightbox-caption="After KYC on the same account: 24h withdrawal limit 8,000,000 USDT.">'
        + '<img src="/screenshots/binance/steps/mob-044d-fees-overview-verified-8m.webp" alt="Binance fees and limits overview after KYC showing an 8,000,000 USDT 24h withdrawal limit (June 2026)" loading="lazy" decoding="async" width="591" height="1280" />'
        + '<figcaption>After KYC on the same account: 24h withdrawal limit — 8,000,000 USDT. Tap to enlarge.</figcaption></figure>'
        + '</div>',
      lastVerified: '2026-06',
      stepCount: 5,
      cta: {
        body: 'KYC is mandatory on Binance — unverified accounts cannot deposit or trade. The process typically takes 5–15 minutes.',
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Choose your country of residence from the dropdown. Select your government-issued ID type: passport, national ID card, or driver\'s license. The options depend on your country — the screenshot shows the Ukrainian flow, where Binance additionally offers a Diia e-ID fast-track at the top of the list.',
          src: '/screenshots/binance/steps/bn-08-kyc-ukraine-doctype-full.webp',
          capturedAt: '2026-06',
          width: 1440,
          height: 709,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance KYC document selection — Ukraine flow with Diia fast-track shown',
          alt: 'Binance KYC country and document selection screen, Ukrainian flow with the Diia e-ID fast-track option at the top (June 2026)',
          mediaCategory: 'KYC',
          tip: 'Use a passport if possible — a single, clear photo page with no address fields verifies fastest. If your country offers a government e-ID fast-track (like Diia in Ukraine, shown above), that is usually even quicker.',
        ...
        },
        {
          ...
          description: 'Take photos of both sides of your ID (front and back for national ID, photo page only for passport — the passport variant with its single upload zone is what the screenshot shows). Requirements: good lighting, all 4 corners visible, no glare, text must be fully readable.',
          src: '/screenshots/binance/steps/bn-10-upload-id-desktop.webp',
          capturedAt: '2026-06',
          width: 1440,
          height: 708,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance document upload — passport photo-page flow shown',
          alt: 'Binance KYC upload screen for the information page of a passport (June 2026)',
          mediaCategory: 'KYC',
        ...
        },
        {
          ...
          description: 'Binance processes identity verification automatically. Most approvals take 2–15 minutes. Complex cases may take up to 24 hours and require manual review. You receive an email notification once verification is complete. The screenshot below is our own Verification Center after approval — the green <strong>Verified</strong> badge plus the unlocked account limits (50K USD daily fiat, unlimited crypto deposits, P2P enabled).',
          src: '/screenshots/binance/steps/bn-mob-053-verification-center-verified.webp',
          capturedAt: '2026-06',
          width: 591,
          height: 1280,
          device: 'mobile',
          aspectRatio: '9/16',
          screenshotLabel: 'Binance Verification Center — Verified badge on our account',
          alt: 'Binance Verification Center on our own account showing the green Verified badge and unlocked account limits (June 2026)',
          mediaCategory: 'KYC',
          ...
          whatHappensNext: 'After approval you get full account access — deposits, withdrawals, and all trading features including futures and P2P. Exact withdrawal limits depend on your verification tier; check them in your Binance account.',
        },
      ],
    },
    {
      ...
      stepCount: 5,
      cta: {
        body: 'Binance P2P charges no platform fee for takers in most markets — the effective cost is typically the spread between P2P offers and spot price. Over 700 payment methods are supported globally.',
        label: 'Use Binance P2P',
      },
      steps: [
        {
          title: 'Navigate to Buy Crypto → P2P Trading',
          description: 'Hover over <strong>Buy Crypto</strong> in the top navigation and click <strong>P2P Trading</strong>. Binance opens on the simplified <strong>Express</strong> view (shown below) — a quick You Pay / You Receive widget. For full control over sellers and prices, switch to the <strong>P2P</strong> tab next to Express.',
          src: '/screenshots/binance/steps/bn-032-p2p-express-buy-usdt.webp',
          capturedAt: '2026-06',
          width: 1440,
          height: 709,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance P2P — Express view that opens first',
          alt: 'Binance P2P Express view with the You Pay / You Receive widget for buying USDT (June 2026)',
          mediaCategory: 'P2P',
          locationHint: 'Top nav → Buy Crypto → P2P Trading',
        },
        {
          title: 'Filter by currency and payment method',
          description: 'Select the coin to buy (USDT recommended for beginners), your local currency, and your preferred payment method. Binance P2P supports over 700 payment methods including bank transfers, PayPal, Revolut, UPI and more. The marketplace lists sellers with their price, available amount, limits and completion rate — exactly what you filter and sort in this step.',
          src: '/screenshots/binance/steps/bn-035-p2p-marketplace-listings.webp',
          capturedAt: '2026-06',
          width: 1440,
          height: 710,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance P2P marketplace — seller listings with filters',
          alt: 'Binance P2P marketplace showing USDT seller listings with prices, order limits, payment methods and completion rates (June 2026)',
          mediaCategory: 'P2P',
        ...
        },
        {
          ...
          description: 'Click on a seller to open their profile — total trades, completion rate, average release time and active offers, exactly as in the screenshot below. If the stats look solid, enter the amount you want to buy (in your local currency) and click <strong>Buy USDT</strong>.',
          src: '/screenshots/binance/steps/bn-037-p2p-seller-profile.webp',
          capturedAt: '2026-06',
          width: 1440,
          height: 710,
          device: 'desktop',
          aspectRatio: '16/9',
          screenshotLabel: 'Binance P2P seller profile — trades, completion rate, offers',
          alt: 'Binance P2P seller profile page showing trade count, completion rate, release time and active offers (June 2026)',
          mediaCategory: 'P2P',
