...
export const AFFILIATE_LINKS: AffiliateEntry[] = [
...

  {
    ...
    links: {
      ...
      affiliateWithCode: 'https://www.binance.com/join?ref=CRYPTOBONW',
    ...
    localizedLinks: [
      ...
      { purpose: 'registration_with_bonus', url: 'https://www.binance.com/join?ref=CRYPTOBONW', isAffiliate: true, hasBonus: true, promoCode: 'CRYPTOBONW' },
      // Owner-confirmed 2026-06-12: official download hub (web/iOS/Android/desktop) with our
      // referral attached. Verified live: redirects to /en/download?ref=CRYPTOBONW, ref survives.
      { purpose: 'download_with_bonus', url: 'https://www.binance.com/download?ref=CRYPTOBONW', isAffiliate: true, hasBonus: true, promoCode: 'CRYPTOBONW', notes: 'App/desktop download page — primary mobile CTA for the flagship app section' },
...

  {
    ...
    links: {
      ...
      affiliateWithCode: 'https://bingxdao.com/partner/CRYPTOBONUSWORLD/',
    ...
    notes: 'BingX partner portal on bingxdao.com. Promo code CRYPTOBONUSWORLD is embedded in the URL path — tracking and bonus activation via partner domain.',
    lastChecked: '2026-06-11',
    sourceOfLink: 'affiliate_dashboard',
    bonusLabel: 'Up to 11,000 USDT Welcome Package',
    maxBonusAmount: 11000,
    bonusCurrency: 'USDT',
    bonusNotes: 'Code CRYPTOBONUSWORLD embedded in bingxdao.com partner URL path; redirects to bingx.com/en/partner/CRYPTOBONUSWORLD (verified 2026-06-11). Referral landing states 11,000+ USDT total: 6,800+ regular welcome gift + 4,200+ referee-exclusive perks (mostly vouchers); typical 50–250 USDT.',
    supportedLocales: ['en'],
    localizedLinks: [
      { purpose: 'registration', url: 'https://bingx.com/', isAffiliate: false, hasBonus: false },
      { purpose: 'registration_with_bonus', url: 'https://bingxdao.com/partner/CRYPTOBONUSWORLD/', isAffiliate: true, hasBonus: true, promoCode: 'CRYPTOBONUSWORLD', notes: 'Promo code CRYPTOBONUSWORLD embedded in partner URL path' },
...

  {
    ...
    maxBonusAmount: 10000,
    bonusCurrency: 'USDT',
    bonusNotes: 'gate.com /share/ path-code. Landing advertises 10,000+ USDT (Sign Up 50 + deposit/trading tasks; VIP chart to 15,000). Verified 2026-06-11 via owner screenshots.',
    supportedLocales: ['en'],
    localizedLinks: [
...

  {
    ...
    links: {
      ...
      affiliateWithCode: 'https://www.kucoin.com/r/af/CRYPTOBONW',
    ...
    notes: 'KuCoin path-based affiliate link /r/af/CRYPTOBONW (replaced rcode= query format 2026-06-11 per owner).',
    lastChecked: '2026-06-11',
    sourceOfLink: 'affiliate_dashboard',
    bonusLabel: 'Up to 500 USDT Welcome Bonus',
    maxBonusAmount: 500,
    bonusCurrency: 'USDT',
    ...
    localizedLinks: [
      ...
      { purpose: 'registration_with_bonus', url: 'https://www.kucoin.com/r/af/CRYPTOBONW', isAffiliate: true, hasBonus: true, promoCode: 'CRYPTOBONW' },
...

  {
    ...
    sourceOfLink: 'affiliate_dashboard',
    bonusLabel: 'Up to 10,000 USDT New User Bonus',
    maxBonusAmount: 10000,
    bonusCurrency: 'USDT',
    bonusNotes: 'inviteCode= on /register page. Landing shows "Perks for new users 10,000 USDT" / "claim 10,000 USDT for new users only" (verified 2026-06-12). Simple clean affiliate URL.',
    supportedLocales: ['en'],
    localizedLinks: [
